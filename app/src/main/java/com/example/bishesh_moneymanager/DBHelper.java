package com.example.bishesh_moneymanager;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String INCOME_TABLE_NAME = "Category";
    public static final String EXPENSE_COLUMN_ID = "id";
    public static final String EXPENSE_COLUMN_CATEGORY_NAME = "category_name";
    public static final String INCOME_COLUMN_CATEGORY_NAME = "category_name";
   // public static final String EXPENSE_COLUMN_CATEGORY_IDENTIFIER = "identifier";
    ...
    public static final String INCOME_TABLE_ADD = "Add_Income";
    public static final String INCOME_ADD_COLUMN_ID = "add_id";
    public static final String INCOME_ADD_COLUMN_CATEGORY_ADD = "category_add";
    public static final String INCOME_ADD_COLUMN_AMOUNT = "amount";
    public static final String INCOME_ADD_COLUMN_DATE = "date";
    public static final String INCOME_ADD_COLUMN_NOTE = "note";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createTableAddInc = "create table Add_Income (add_id integer primary key AUTOINCREMENT, category_add, amount, date, note);";
        db.execSQL(createTableAddInc);
    }
    ...
    public void insertCategory(String category_name) {
        ...
        values.put(INCOME_COLUMN_CATEGORY_NAME, category_name);//column name, column value

        // Inserting Row
        db.insert(EXPENSE_TABLE_NAME, null, values);//tableName, nullColumnHack, ContentValues
//        db.close(); // Closing database connection

//        db.insert(INCOME_TABLE_NAME, null, values);//tableName, nullColumnHack, ContentValues
        db.close(); // Closing database connection
    ...
    public void insertAdd_Income(String category_add, String amount, String date, String note) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(INCOME_ADD_COLUMN_CATEGORY_ADD, category_add);
        values.put(INCOME_ADD_COLUMN_AMOUNT, amount);
        values.put(INCOME_ADD_COLUMN_DATE, date);
        values.put(INCOME_ADD_COLUMN_NOTE, note);
        db.insert(INCOME_TABLE_ADD, null, values);
        db.close();
    }
    ...
    public Cursor getsumIncomeAmount(int id) {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor_EA = db.rawQuery("select sum(amount) from Add_Income where category_add = '$category_add' ", null);
        return cursor_EA;
    }
